...
return [
    ...
    'bill_description_description' => 'Gib bitte alle relevanten Informationen an, die helfen, diese Abrechnung zu bearbeiten: z. B. #Wofür, #Warum, #Projekte, #Besondere Bedingungen usw.',
    ...
    'advance_payment_tooltip' => 'Wenn du das Geld erhalten haben, bevor du etwas kaufen, und später die Rechnung erhältst, nachdem du bezahlt hast, dann kannst du hier den Betrag eingeben, den du bereits im Vorraus erhalten hast, damit der Buchhalter weiß, dass du den eingegebenen Betrag bereits erhalten haben.',
    'reason' => 'Grund',
    ...
    'sub_category_create_note_1' => 'Vor dem Hinzufügen einer Kategorie bitte den Eintrag erstellen',
    'inventory_department_note_1' => 'Die Abteilung kann im Moment nicht im Nachhinein geändert werden',
    'department_sub_category' => 'Unterkategorie in Abteilung',
    'edit_sub_category' => 'Kategorie bearbeiten',
    ...
    'repayment_method_tooltip' => 'Auf welche Art und Weis und Wohin möchtest du das Geld erstattet haben? Hier kannst du deine z.B. deine Bank Daten für die Überweisung eingeben. Soll der Betrag an den Rechnungsteller überwiesen werden der im eingereichten Dokument steht, muss das nicht ausgefüllt werden. Dann bitte den Haken im entsprechenden Feld setzten.',
    ...
    'bill_amount' => 'Erstattungssumme',
    'bill_amount_tooltip' => 'Der Betrag, den du zurückbekommen möchten. Es spielt keine Rolle, ob 0% MwSt. oder etwas anderes.',
    ...
    'create_token' => 'Neues API Token erstellen',
    'token_created' => 'API Token erstellt',
    'token_deleted' => 'API Token gelöscht',
    'token_name_required' => 'Name des Tokens ist erforderlich',
    'token_abilities_required' => 'Mindestens eine Berechtigung muss ausgewählt werden',
    'token_abilities_invalid' => 'Ungültige Berechtigungen ausgewählt',
