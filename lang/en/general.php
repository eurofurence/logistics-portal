...
return [
    ...
    'bill_description_description' => 'Please provide any relevant information that will help process this bill: e.g. #What for, #Why, #Projects, #Special conditions etc.',
    ...
    'advance_payment_tooltip' => 'When you got the money before you buy something, and later you get the Invoice after you payed, then you can enter the amount you already got, so the accountant knows you already got the entered amount.',
    'reason' => 'Reason',
    ...
    'locations' => 'Locations',
    'status_descriptions' => [
        'on_hold' => 'The order is on hold. This means that the order will not be processed for the time being. This may be the case, for example, if clarification or consultation is pending.',
        'checking' => 'It is being checked whether the order can be executed or if other particularities could have an influence. This status can also be assigned when availability is being inquired.',
    ...
    'operation_site_create_note_2' => 'Operationg sites in your department',
    'custom_fields' => 'Custom fields',
    'field_name' => 'Field name',
    'copy' => 'Copy',
    'entry_duplicated' => 'Entry duplicated',
    'duplicate_note_1' => 'Please note that files will not be duplicated',
    'add_operation_site' => 'Add operation site',
    ...
    'repayment_method_tooltip' => 'How and where would you like to have the money refunded? Here you can enter your bank details for the transfer, for example. If the amount is to be transferred to the invoicing party stated in the submitted document, this does not need to be filled in. Then please check the appropriate box.',
    ...
    'bill_amount' => 'Reimbursement amount',
    'bill_amount_tooltip' => 'The amount you want to get back. It does not matter if 0% Vat or something else.',
    ...
    'token_abilities_required' => 'At least one ability must be selected',
    'token_abilities_invalid' => 'Invalid abilities selected',
