...
return [
    ...
    'notifications' => [
        ...
        'discord' => [
            'webhook_url' => env('BACKUP_DISCORD_NOTIFICATION_WEBHOOK', ''),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => env('BACKUP_STORAGE_TIME', 7),
             ...
             */
            'keep_daily_backups_for_days' => env('BACKUP_STORAGE_TIME', 7),
