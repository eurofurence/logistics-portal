<html lang="en" style="--X: 0.13645833333333335; --Y: -0.17720090293453722;"><head>
    <meta charset="UTF-8">


      <link rel="apple-touch-icon" type="image/png" href="@assets('favicon.ico')">

      <meta name="apple-mobile-web-app-title" content="CodePen">

      <link rel="shortcut icon" type="image/x-icon" href="@assets('favicon.ico')">

      <link rel="mask-icon" type="image/x-icon" href="@assets('favicon.ico')">
    ...
    <title>Internal Server Error - Error 500 Makes bear sad 🐻😭</title>

      <link rel="author" href="https://codepen.io/jh3y/pen/BaNOJWK">
  ...
  * {
  ...
  const FourOhFour = () => {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement(Code, { className: "four-oh-four__code" }, "500"), /*#__PURE__*/
      React.createElement(CodeMessage, { className: "four-oh-four__code-message" }, "Internal_Error "))));
