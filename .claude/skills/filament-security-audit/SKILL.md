...
description:
  Audit a Filament v4 application for security issues and write a per-finding
...
Audit how the application _uses_ Filament v4, not Filament's own source.
...
Docs: https://filamentphp.com/docs/4.x/tables/columns/toggle#authorization
...
(https://filamentphp.com/docs/4.x/testing/overview).
...
Every Filament v4 security notice, grouped by category (A–E). Each entry lists
**Search**, **Flag if**, **Fix**, **Docs**, with **Why** / **Safe when** /
**Exceptions** where useful. Reference:
https://filamentphp.com/docs/4.x/advanced/security
...
- **Why**: bulk actions authorize the whole batch once against `*Any()`, never
  ...
  N/A there.)
- **Docs**:
  - https://filamentphp.com/docs/4.x/resources/deleting-records#authorization
  - https://filamentphp.com/docs/4.x/actions/delete#improving-the-performance-of-delete-bulk-actions
...
- **Docs**:
  https://filamentphp.com/docs/4.x/actions/import#per-record-authorization
...
- **Why**: in v4 `can*()` still gates page access, navigation, and global
  ...
  action leaks.
- **Docs**:
  https://filamentphp.com/docs/4.x/upgrade-guide#overriding-the-can-authorization-methods-on-a-resource-relationmanager-or-managerelatedrecords-class
...
- **Docs**:
  - https://filamentphp.com/docs/4.x/tables/columns/toggle#authorization
  - https://filamentphp.com/docs/4.x/tables/columns/text-input#authorization
  - https://filamentphp.com/docs/4.x/tables/columns/select#authorization
...
- **Docs**:
  https://filamentphp.com/docs/4.x/advanced/security#restricting-livewire-file-uploads-to-schema-components
...
- **Docs**:
  https://filamentphp.com/docs/4.x/advanced/security#authorization-and-the-livewire-request-lifecycle
...
- **Docs**:
  - https://filamentphp.com/docs/4.x/forms/file-upload#authorizing-existing-file-paths
  - https://filamentphp.com/docs/4.x/forms/rich-editor#securing-file-attachment-ids
...
- **Why**: preserving the client filename keeps a `.php` extension on disk;
  ...
  closes the gap.
- **Docs**:
  https://filamentphp.com/docs/4.x/forms/file-upload#security-implications-of-controlling-file-names
...
- **Docs**:
  - https://filamentphp.com/docs/4.x/forms/rich-editor#security
  - https://filamentphp.com/docs/4.x/forms/markdown-editor#security
...
- **Docs**:
  - https://filamentphp.com/docs/4.x/tables/columns/text#rendering-raw-html-without-sanitization
  - https://filamentphp.com/docs/4.x/infolists/text-entry#rendering-raw-html-without-sanitization
  - https://filamentphp.com/docs/4.x/schemas/primes#text-component
...
- **Docs**:
  https://filamentphp.com/docs/4.x/advanced/security#validating-user-input
...
- **Docs**:
  - https://filamentphp.com/docs/4.x/forms/select#allowing-html-in-the-option-labels
  - https://filamentphp.com/docs/4.x/tables/columns/select#allowing-html-in-the-option-labels
...
- **Fix**: ensure no message interpolates unescaped user data, or remove the
  call.
- **Docs**:
  https://filamentphp.com/docs/4.x/forms/validation#allowing-html-in-validation-messages
...
- **Why**: these strings are `eval()`'d client-side, so PHP-side interpolation
  of user data → XSS.
- **Docs**:
  - https://filamentphp.com/docs/4.x/forms/overview#hiding-a-field-using-javascript
  - https://filamentphp.com/docs/4.x/actions/overview#running-javascript-when-an-action-is-clicked
...
- **Docs**: https://filamentphp.com/docs/4.x/advanced/security#scoping-queries
...
- **Docs**:
  https://filamentphp.com/docs/4.x/resources/overview#protecting-model-attributes
...
- **Docs**: https://filamentphp.com/docs/4.x/users/tenancy#tenancy-security
...
- **Docs**:
  https://filamentphp.com/docs/4.x/users/tenancy#unique-and-exists-validation
